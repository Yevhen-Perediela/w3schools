...
<body>
    ...
    <p>We fund our site by showing adverts as you browse our site. These adverts are usually managed by a partner specializing in providing adverts for multiple sites. You can review their privacy and cookie policy here.</p>
    ...
    <p>If you want to change your choices regarding your personal information, you can use the button below:</p>
    ...
    <p>Our Tryit Editor allows users to store code to, or import code from, Google Drive.</p>
    <ul>
        <li>Store examples/code to their Google Drive</li>
        <li>Share examples/code through Google Drive</li>
    </ul>
    <p>W3Schools does not keep for ourselves, or share this information with third parties.</p>
