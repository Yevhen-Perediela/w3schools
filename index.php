...
<body>
    ...
    <div class="wave-transition" id="wave-transition">
        <svg viewBox="0 0 1440 320" preserveAspectRatio="none">
            <path fill="#1a1b26" d="M0,160L48,165C96,170,192,180,288,176C384,172,480,154,576,144C672,134,768,134,864,144C960,154,1056,176,1152,181C1248,186,1344,176,1392,170L1440,165L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>
